<div class="spacer-left-dbl">	
	...
	<a href="<?php echo site_url('blog/rss/all|rss'); ?>"><strong><?php echo lang('news_all_articles_label');?></strong><br /></a>	
	<?php if(isset($category) && is_object($category)): ?>	
		...
		<a href="<?php echo site_url('blog/rss/'.$category->slug.'|rss'); ?>"><strong><?php echo $category->title;?> <?php echo lang('news_articles_of_category_suffix');?></strong></a>
	<?php endif;?>	
</div>
