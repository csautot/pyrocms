...
<div class="box">
	...
	<h4><?php echo anchor('admin/blog/create', lang('news_create_title')) ?></h4>
				...
				<tbody>
					<?php foreach ($news as $article): ?>
						<tr>
							...
							<td>
								<?php echo anchor('admin/blog/preview/' . $article->id, lang($article->status == 'live' ? 'news_view_label' : 'news_preview_label'), 'rel="modal-large" class="iframe" target="_blank"') . ' | '; ?>
								<?php echo anchor('admin/blog/edit/' . $article->id, lang('news_edit_label'));?> | 
								<?php echo anchor('admin/blog/delete/' . $article->id, lang('news_delete_label'), array('class'=>'confirm')); ?>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>	
